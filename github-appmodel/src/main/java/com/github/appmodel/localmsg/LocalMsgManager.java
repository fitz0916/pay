package com.github.appmodel.localmsg;
...
import com.github.appmodel.constant.UnknownErrorCodeConstant;
...
public class LocalMsgManager {
	...
	private transient Logger log = LoggerFactory.getLogger(LocalMsgManager.class);
	...
	private void loadPropertiesToMap(String fileClassPath) {
		...
		try {
			...
			// 放这个能排掉 load() 失败的未知不良影响，也能包在catch (Exception)中
