...
<script src="${basePath}/resources/plugins/bootstrap-3.3.0/js/bootstrap-select.js"></script>
<script src="${basePath}/resources/uploadifive/jquery.uploadifive.min.js"></script>
<script src="${basePath}/resources/plugins/bootstrap-3.3.0/js/bootstrap-select.js"></script>
<script src="${basePath}/resources/plugins/bootstrap-3.3.0/js/bootstrap-table-export.js"></script>
<script src="${basePath}/resources/plugins/bootstrap-3.3.0/js/tableExport.js"></script>
<script src="${basePath}/resources/plugins/bootstrap-3.3.0/js/fileinput.js"></script>
<script src="${basePath}/resources/plugins/bootstrap-3.3.0/js/fileinput_locale_zh.js"></script>
<script src="${basePath}/resources/plugins/bootstrap-3.3.0/js/bootstrap-datetimepicker.js"></script>
<script src="${basePath}/resources/plugins/bootstrap-3.3.0/js/bootstrap-datetimepicker.zh-CN.js"></script>
<script src="${basePath}/resources/plugins/select-area/city.js"></script>
<script src="${basePath}/resources/plugins/select-area/select-area.js"></script>
<script src="${basePath}/resources/plugins/daterangepicker/moment.min.js"></script>
<script src="${basePath}/resources/plugins/daterangepicker/daterangepicker.js"></script>
