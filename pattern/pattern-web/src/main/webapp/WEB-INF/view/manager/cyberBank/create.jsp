				...
				<div class="form-group">
					<div class="fg-line">
						<div class="form-group">
							...
							<input id="bankLogo" type="hidden" class="form-control" name="bankLogo" maxlength="100">
						</div>
						<div class="form-group">
							<label for="bankName">银行名称</label>
							<input id="bankName" type="text" class="form-control" name="bankName" maxlength="20">
						</div>
						<div class="form-group">
							<label for="bankNum">银行编码</label>
							<input id="bankNum" type="text" class="form-control" name="bankNum" maxlength="20">
						</div>
						<div class="form-group">
						...
						<div class="radio">
							<div class="radio radio-inline radio-success">
								<input id="bankType_1" type="radio" name="bankType" value="1" style="margin-left: 11px;" checked>
								<label for="bankType_1">借记卡</label>
							</div>
							<div class="radio radio-inline radio-info">
								<input id="bankType_2" type="radio" name="bankType" value="2" style="margin-left: 11px;">
								<label for="bankType_2">信用卡</label>
							</div>
						</div>
						<div class="radio">
							<div class="radio radio-inline radio-success">
								<input id="available_1" type="radio" name="available" value="1" style="margin-left: 11px;" checked>
								<label for="available_1">启用</label>
							</div>
							<div class="radio radio-inline radio-info">
								<input id="available_0" type="radio" name="available" value="0" style="margin-left: 11px;">
