...
function initMyTable(){
	$table.bootstrapTable({
		url: '${basePath}/manage/whitelist/list',	//获取表格数据的url
		method:'post',
		dataType:'json',
		...
		columns: [
			...
			{field:'whiteListId',title:'ID',align:'center'},
...
function createAction() {
    createDialog = $.dialog({
        ...
        containerFluid: true,
        title: '新增白名单',
        content: 'url:${basePath}/manage/whitelist/create',
...
function updateAction() {
    ...
    if (rows.length > 1 || rows.length < 0) {
        ...
        updateDialog = $.dialog({
            title: '编辑白名单',
            columnClass: 'col-md-10 col-md-offset-1 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1',
            content: 'url:${basePath}/manage/whitelist/update/'+rows[0].whiteListId,
            onContentReady:function(){
            	 initMaterialInput();
            },
            contentLoaded: function(data, status, xhr){
