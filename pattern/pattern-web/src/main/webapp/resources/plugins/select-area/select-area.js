...
(function (factory) {
    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%;' +
                    ...
                    (this.includeDem('district') ? '<a data-count="district">县区</a>' : '') +
        ...
        bind: function () {
            ...
            this.$dropdown.on('click', '.city-select a', function () {
                ...
                if ($active.data('code') !== $(this).data('code')) {
                    ...
                    getProxyInfo(address,code);//create.jsp
        ...
        output: function (type) {
            ...
            streets = $.isNumeric(code) ? ChineseDistricts[code] : null;
           

            if ($.isPlainObject(streets)) {
                $.each(streets, function (code, address) {
                    var provs;
                    if (type === PROVINCE) {
                        provs = [];
