...
public class PaySignUtil {
	 ...
	 * @param signObj
	 *            需要签名实体类
	 * @param agentSecretKey
	 *            商户密钥
	 * @param ignoreProperties
	 *            忽略的属性
	 * @return 参数值
	 */
	public static<T> String requestMd5Sign(T t, String agentSecretKey, String... ignoreProperties) throws PaymentException {
//		VerifyParamtersUtils.verifyParameters(signObj); // 验证参与签名的参数
		Map<String, Object> map = VerifyParamtersUtils.toEncryptionMap(t, false, false, ignoreProperties); // 参数排序
		String sortPostParam = VerifyParamtersUtils.mapToPostUrl(map); // 获取排序后的post参数
		System.out.println(sortPostParam);
...
//		GatewayPaymentRequest paymentRequest = new GatewayPaymentRequest();
...
//		paymentRequest.setMerId("2341"); // 商户ID
